...
const COMMITTEE_DATA = {
    ...
    technicalProgramCommitteeMembers: [
        ...
        { name: "Dr. Thamotharan Balakrishnan", affiliation: "SASTRA Deemed University, Thanjavur, Tamil Nadu, India" },

        // --- Additional TPC members (from TPC.xlsx) ---
        { name: "Aamir Ali", affiliation: "IILM University, Greater Noida" },
        { name: "Aarthi E", affiliation: "SRM IST Kattankulathur" },
        { name: "Abrar Ahmed Raza", affiliation: "Lovely professional university (LPU)" },
        { name: "Ajay Kumar", affiliation: "IILM University, Greater Noida" },
        { name: "Akilan T", affiliation: "Amity University, Kolkata" },
        { name: "Alok Choudhury", affiliation: "Assam Don Bosco University" },
        { name: "Alok Kumar Tiwari", affiliation: "Bennett University" },
        { name: "Amit Katoch", affiliation: "IILM University" },
        { name: "Amit Panwar", affiliation: "UPES DEHRADUN" },
        { name: "Amit Singh", affiliation: "cisco" },
        { name: "Anand Kumar", affiliation: "IILM University, Greater Noida" },
        { name: "Anjum Mohd Aslam", affiliation: "Sharda University" },
        { name: "Ankita Agarwal", affiliation: "IILM University, Greater Noida" },
        { name: "Anurag Agarwal", affiliation: "IMSEC, GHAZIABAD" },
        { name: "Apoorva Verma", affiliation: "Asian School of Business" },
        { name: "Archana Singh", affiliation: "Anand Engineering College" },
        { name: "Ashis Kumar Ratha", affiliation: "IILM University" },
        { name: "Ashwini K Kumar", affiliation: "Arka Jain University" },
        { name: "Bhavana Kaushik", affiliation: "University of Petroleum and Energy Studies" },
        { name: "Chandra Shekhar Yadav", affiliation: "DST" },
        { name: "Daruvuri Rajesh", affiliation: "Google Cloud" },
        { name: "Deepak Chandra Uprety", affiliation: "Noida Institute of Engineering and Technology" },
        { name: "Dilip Kumar", affiliation: "NIT Jamshedpur" },
        { name: "Divya Singhal", affiliation: "IILM University, Greater Noida" },
        { name: "Dr. Aslam J Karjagi", affiliation: "SECAB I E T" },
        { name: "Dr. Bharat Pahadiya", affiliation: "Medicaps University" },
        { name: "Dr. Nazia Tabassum", affiliation: "IILM University, Greater Noida" },
        { name: "Dr. Ritu Patidar", affiliation: "Adani University" },
        { name: "Dr. Sonal Shukla", affiliation: "IILM University, Greater Noida" },
        { name: "Dr. Vipul Dixit", affiliation: "Bennett University, Greater Noida" },
        { name: "Dr. Sumit Kumar", affiliation: "IILM University, Greater Noida" },
        { name: "Gagan Deep Singh", affiliation: "UPES" },
        { name: "Gajraj Singh", affiliation: "SVNIT Surat" },
        { name: "Gaurav Nagarkoti", affiliation: "IILM University" },
        { name: "Harendra S. Jangwan", affiliation: "IILM University" },
        { name: "Hari Saroop", affiliation: "Noida Institute of Engineering and Technology" },
        { name: "Heena Phogat", affiliation: "IILM University, Greater Noida" },
        { name: "Hilal Ahmad", affiliation: "IILM University, Greater Noida" },
        { name: "Irfan Bagawan", affiliation: "MLR Institute of Technology, Hyderabad" },
        { name: "Isha Chopra", affiliation: "Maharishi Markandeshwar (Deemedto be) University" },
        { name: "Ishwar Bansal", affiliation: "Amazon Development Center" },
        { name: "Jairam Naik K", affiliation: "NIT Raipur" },
        { name: "Jyoti Kataria", affiliation: "Starex University, Gurugram" },
        { name: "Jyoti Sharma", affiliation: "CHITKARA UNIVERSITY" },
        { name: "Karishma Arora", affiliation: "Jayoti Vidyapeeth Women's University, Jaipur" },
        { name: "Karishma Sharma", affiliation: "Asian School of Business" },
        { name: "Kavita Saini", affiliation: "Galgotias University" },
        { name: "Kavitha K R", affiliation: "Sona College of Technology" },
        { name: "Lakshmi Narayanan S G", affiliation: "Norton Lifelock" },
        { name: "Lalita Kumari", affiliation: "Amity University Patna" },
        { name: "Manali Gupta", affiliation: "IILM University" },
        { name: "Manimala G", affiliation: "SRI SAI RAM ENGINEERING COLLEGE" },
        { name: "Manoj Dhawan", affiliation: "Avantika University, Ujjain" },
        { name: "Manoj Varma Lakhamraju", affiliation: "CVS Health" },
        { name: "Manu V Mishra", affiliation: "HCL America" },
        { name: "Manu Vardhan", affiliation: "NIT Raipur" },
        { name: "Mitali Chugh", affiliation: "UPES" },
        { name: "Monu Sharma", affiliation: "Valley Health System" },
        { name: "Naga Kr Muppidi", affiliation: "Hedgeserv" },
        { name: "Narinder Verma", affiliation: "IILM University" },
        { name: "Neelam Rawat", affiliation: "KIET Group of Institutions" },
        { name: "Neha Bishnoi", affiliation: "Chandigarh University" },
        { name: "Nishant Upadhyay", affiliation: "Gniot, Greater Noida" },
        { name: "Nitasha Tayal", affiliation: "Galgotias College of Engineering and Technology" },
        { name: "Nitin Grover", affiliation: "Ernst & Young" },
        { name: "Pankaj Sharma", affiliation: "IILM University" },
        { name: "Parthasarathi De", affiliation: "Narula Institute of Technology, Kolkata" },
        { name: "Poonam Yadav", affiliation: "IILM University" },
        { name: "Pradeep Sharma", affiliation: "ServiceNow" },
        { name: "Prasanthi Kumari Nunna", affiliation: "UPES" },
        { name: "Premananda Sahu", affiliation: "School of Computing and Artificial Intelligence, Lovely Professional University, Phagwara, Punjab" },
        { name: "Priyanka Kumari", affiliation: "Yogoda Satsanga Mahavidyalaya, Ranchi" },
        { name: "Rajesh Daruvuri", affiliation: "Google" },
        { name: "Rajkumar Varshney", affiliation: "Dr. BR Ambedkar National Institute of Technology Jalandhar" },
        { name: "Rashmi Bhardwaj", affiliation: "Sharda University, Greater Noida" },
        { name: "Reeta Mishra", affiliation: "IILM University, Greater Noida" },
        { name: "Ritu Dewan", affiliation: "IILM University" },
        { name: "Ritu Gothwal", affiliation: "IILM University, Greater Noida" },
        { name: "Rizwana Kallooravi Thandil", affiliation: "Sullamussalam Science College Areekode" },
        { name: "Rohan G Kulkarni", affiliation: "Meta" },
        { name: "Rohit Kumar", affiliation: "IILM University, Greater Noida" },
        { name: "Sachin Yele", affiliation: "Medi-Caps University, Indore" },
        { name: "Sai Reddy Anugu", affiliation: "randstad Digital" },
        { name: "Sakshi Gupta", affiliation: "Dronacharya College of Engineering" },
        { name: "Sandeep Kumar", affiliation: "IIT Kharagpur" },
        { name: "Saroj Kumari", affiliation: "Yogoda Satsanga Mahavidyalaya, Ranchi" },
        { name: "Shalini Singh", affiliation: "Quantum University, Roorkee, India" },
        { name: "Sheikh Moeen Ul Haque", affiliation: "Bennett University" },
        { name: "Shilpa Tyagi", affiliation: "SRM University" },
        { name: "Shobit Agrawal", affiliation: "IILM University, Greater Noida" },
        { name: "Shubham Kumar Singh", affiliation: "NIT Jalandhar" },
        { name: "Simran Chugwani", affiliation: "IILM University, Greater Noida" },
        { name: "Simran Saxena", affiliation: "University Institute of Engineering and Technology, Panjab University" },
        { name: "Somnath Banerjee", affiliation: "AWS" },
        { name: "Sreenivasarao D", affiliation: "NIT Warangal" },
        { name: "Subrata Pan", affiliation: "Department of Information Technology, Bankura Unnayani Institute of Engineering" },
        { name: "Sujit Kumar Badodia", affiliation: "IET, DAVV Indore" },
        { name: "Suresh Hatti", affiliation: "Dell Technologies" },
        { name: "Suresh Kumar Gunasekaran", affiliation: "Walmart Global Tech" },
        { name: "Suriyakrishnaan K", affiliation: "Sona College of Technology" },
        { name: "Sushree Sasmita Dash", affiliation: "IIMT College of Engineering" },
        { name: "Swapnil Nagar", affiliation: "Microsoft" },
        { name: "Swati Vishnoi", affiliation: "Banasthali Vidyapith" },
        { name: "Tanvi Rustagi", affiliation: "Shree Guru Gobind Singh Tricentenary University, Gurugram" },
        { name: "Tarun Eldho Alias", affiliation: "Neem Inc" },
        { name: "Thiyagarajan Mani Chettier", affiliation: "Independent Researcher" },
        { name: "Uma Rani", affiliation: "ADGIPS, New Delhi" },
        { name: "Vamshidhar Reddy Vemula", affiliation: "Intalent LLC" },
        { name: "Varsha Srivastava", affiliation: "CSIR-NPL" },
        { name: "Veera Ravindra Divi", affiliation: "Amazon" },
        { name: "Venkata Kalyan Tavva", affiliation: "Indian Institute of Technology Ropar" },
        { name: "Venugopalachary Kotha", affiliation: "UPES" },
        { name: "Vikas Chauhan", affiliation: "Galgotias University, Greater Noida" },
        { name: "Vishakha Agarwal", affiliation: "IILM University, Greater Noida" },
        { name: "Yamini Singh", affiliation: "IILM University" },
        { name: "Yash Garg", affiliation: "Dr. B.R. Ambedkar National Institute of Technology" },
        { name: "Yogesh K Mali", affiliation: "G H Raisoni College of Enginerring & Management Wagholi Pune" },
    ],
};

const Community = () => {
    useEffect(() => {
        document.title = "Organizing Committee - ICABCR 2027";
    }, []);
        ...
        <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
            ...
            <nav className="fixed w-full z-50 bg-white/95 backdrop-blur-md border-b border-slate-200 py-4 shadow-sm">
                <div className="container mx-auto px-6 md:px-12 flex justify-between items-center">
                    <Link to="/icabcr2027" className="flex items-center gap-4 group">
                ...
                <div className="container mx-auto px-6 md:px-12 relative z-10">
                    ...
                    >
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <p className="text-xs uppercase tracking-[0.3em] font-bold text-emerald-400">ICABCR-2027</p>
                        </div>
