...
const slides = [
  ...
  },
  {
    ...
    content: [
   <a href="https://www.ieee.org/conferences/publishing/templates.html" target="_blank" rel="noopener noreferrer" className="text-blue-600 font-bold hover:underline">Download Word Template</a>
...
const Cfp = () => {
  useEffect(() => {
    document.title = "Call for Papers - ICABCR 2027";
  }, []);
      ...
      <header className="pt-32 pb-16 bg-slate-950 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <motion.div initial="hidden" animate="visible" variants={fadeInUp}>
            <div className="flex items-center gap-4 mb-6"><span className="h-[1px] w-12 bg-amber-400"></span><p className="text-xs uppercase tracking-[0.3em] font-bold text-amber-400">ICABCR-2027</p></div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Call for Papers</h1>
            <p className="text-lg text-slate-400 max-w-2xl font-light">
              The International Conference on AI Based Cyber Resilience (ICABCR-2027) 
          ...
          <div className="prose prose-slate max-w-none text-slate-600 leading-relaxed">
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-8">
              ...
              <div className="bg-white p-6 border border-slate-200 rounded-lg">
                ...
                <p>
                  Accepted and presented papers will be published by <strong>IEEE</strong>, subject to meeting quality and formatting standards.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="p-8 space-y-6">
              <div className="flex gap-4">
                ...
                <p><strong>Format:</strong> Papers must be formatted according to the IEEE conference template (two-column, A4 size).</p>
              </div>
              <div className="flex gap-4">
                <CheckCircle className="text-emerald-500 shrink-0" size={20} />
