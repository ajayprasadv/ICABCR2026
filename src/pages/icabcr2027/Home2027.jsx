...
const ICADC_CONTENT = {
  deadlines: [
    ...
    { label: "Conference Date", date: "Oct 08-9, 2027", status: "Upcoming", color: "text-indigo-500", bg: "bg-indigo-50" }
  ],
...
const App = () => {
  ...
  useEffect(() => {
    document.title = "ICABCR 2027 - International Conference on AI Based Cyber Resilience";
  }, []);
...
Situated in the dynamic educational hub of Greater Noida, IILM University promotes hands-on engineering practices, interdisciplinary learning, and strong industry collaboration. The institution is actively building capabilities in AI engineering, cybersecurity infrastructure development, and advanced computing systems, positioning itself as a center for next-generation technology education and research.
      ...
      >
          ...
          <div className="flex items-center gap-4 md:gap-5">
            <a href="#" className="flex items-center gap-4 group">
              <div className="flex flex-col">
                <img src={confLogo} alt="conference logo" className="h-10 md:h-12 w-auto object-contain" />
              </div>
            </a>
            <span className="hidden sm:block w-[1px] h-9 bg-slate-200"></span>
        ...
        <div className="hidden lg:flex justify-center items-center gap-8 border-t border-slate-200/60 mt-4 pt-3 px-6 md:px-12">
      ...
      {/* --- HERO SECTION --- */}
      <header className="relative min-h-[100vh] flex items-center pt-40 md:pt-40 pb-12 overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-950 text-white">
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            <motion.div
              ...
              className="min-w-0 lg:col-span-8 space-y-5 md:space-y-7"
            >
              <br />
              <br />
              <br />
              ...
              <motion.div variants={fadeInUp} className="text-lg md:text-2xl font-semibold text-amber-300 tracking-wide">
                Oct 08-9, 2027 at IILM University, Greater Noida, India
              </motion.div>
...
redefining the architecture of trust and technological advancement.
              ...
              <motion.div variants={fadeInUp} className="lg:hidden flex items-center gap-4 py-3 px-4 bg-slate-800/50 backdrop-blur-sm border border-amber-400/30 rounded-lg shadow-sm">
                ...
                <div>
                  <p className="text-sm font-bold text-amber-100">Oct 08-9, 2027</p>
                  <p className="text-xs text-amber-300/70">IILM University, Greater Noida, India</p>
                </div>
              </motion.div>
